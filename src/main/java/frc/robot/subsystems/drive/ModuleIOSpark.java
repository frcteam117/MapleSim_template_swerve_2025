...
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module) {
        ...
        turnConfig
                ...
                .positionConversionFactor(turnAbsEncoderPositionFactor)
                .velocityConversionFactor(turnAbsEncoderVelocityFactor)
                .averageDepth(2);
        turnConfig
                .closedLoop
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        ifOk(driveSpark, driveSpark::getOutputCurrent, (value) -> inputs.driveStatorCurrentAmps = value);
        ...
        ifOk(turnSpark, turnSpark::getOutputCurrent, (value) -> inputs.turnStatorCurrentAmps = value);
