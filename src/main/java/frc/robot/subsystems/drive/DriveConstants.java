...
public class DriveConstants {
    public static final double maxSpeedMetersPerSec = Units.feetToMeters(16.3);
    public static final double odometryFrequency = 100.0; // Hz
    public static final double trackWidth = Units.inchesToMeters(21.625 - (2 * 1.6875));
    public static final double wheelBase = Units.inchesToMeters(21.625 - (2 * 1.6875));
    ...
    public static final double wheelRadiusMeters = Units.inchesToMeters((3.875 - .12) / 2);
    public static final double driveMotorReduction = 6.25666667;
    ...
    public static final double turnAbsEncoderVelocityFactor = (2 * Math.PI) / 60.0; // RPM -> Rad/Sec
    public static final double turnEncoderPositionFactor = 2 * Math.PI / 25; // Rotations -> Radians
    public static final double turnEncoderVelocityFactor = (2 * Math.PI / 25) / 60.0; // RPM -> Rad/Sec
