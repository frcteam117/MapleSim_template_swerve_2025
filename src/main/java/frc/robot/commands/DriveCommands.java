...
public class DriveCommands {
  ...
  public static Command joystickDrive(
    ...
    return Commands.run(
            () -> {
              ...
              // double maxLinearVelocity = drive.getMaxLinearSpeedMetersPerSec();
              // double maxAngularVelocity = drive.getMaxAngularSpeedRadPerSec();
        ...
        Commands.sequence(
            ...
            Commands.run(
                () -> {
                  ...
                  drive.setNextVelocity(new ChassisSpeeds(0.0, 0.0, speed));
                },
                drive)),
  ...
  public static Command pathToReef(Supplier<Pose2d> poseSupplier, BooleanSupplier getButton) {
    ...
    PathConstraints constraints = new PathConstraints(5, 6, 7, 7, 12);
