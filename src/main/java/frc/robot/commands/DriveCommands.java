...
public class DriveCommands {
    ...
    public static Command pathToReef(Supplier<Pose2d> poseSupplier, BooleanSupplier getButton) {
        ...
        //         );
        // path.preventFlipping = true;
        // Command pathCommand = AutoBuilder.pathfindToPose(waypoint, constraints, constraintsSlow.maxVelocity());
        ...
        //     List<Waypoint> waypointsSlow = PathPlannerPath.waypointsFromPoses(poseSupplier.get(), waypoint1,
        // waypoint2);
        ...
        //             new GoalEndState(
        //                     0.0,
        //                     waypoint2.getRotation()) // Goal end state. You can set a holonomic rotation here. If
        // using
        //             // a
        //             // differential drivetrain, the rotation will have no effect.
        //             );
